  ...
  <v-single-k3 #="slot"
    ><v-vanta-waves-k3
      ...
      ><v-template-banner-k3
        ...
        :variant="variant"
      ></v-template-banner-k3></v-vanta-waves-k3
  ></v-single-k3>
</template>
<script setup>
...
const props = defineProps({
  ...
  shininess: { default: undefined, type: Number },
  waveHeight: { default: undefined, type: Number },
  waveSpeed: { default: undefined, type: Number },
