        ...
        :init="{
          ...
          templates: [
            ...
            },
            {
              ...
              content:
                '<v-single-banner-clouds-k3></v-single-banner-clouds-k3>',
            },
            {
              title: 'single banner clouds2',
              description: 'v-single-banner-clouds2-k3',
              content:
                '<v-single-banner-clouds2-k3></v-single-banner-clouds2-k3>',
            },
            {
            ...
            },
            {
              ...
              content:
                '<v-single-banner-ripple-k3></v-single-banner-ripple-k3>',
            },
            {
