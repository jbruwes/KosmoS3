        ...
        templates: [
          ...
          },
          {
            ...
            content: grid
              ...
              .replace(
                "#{content}",
                `<div class="ui fluid raised link card">${dimmedImage
                  .replace("#{loading}", "eager")
                  .replace("#{size}", "")}${header}</div>`
              ),
          },
          {
            title: "carousel",
          ...
          },
          {
            ...
            content:
              `${
                ...
                '"' +
                " "
              }${['data-id="pageheader"', commonData, singleData].join(" ")} ` +
              `style="min-height:100vh;">` +
              `<div class="ui active very light dimmer">${header}</div></div>`,
          },
          {
            title: "headerlist",
          ...
          },
          {
            ...
            content: `<div class="ui placeholder segment mceNonEditable">${grid
          ...
          },
          {
            ...
            content: grid
              ...
              .replace(
                "#{data}",
                ['data-id="icongrid"', commonData, singleData, multiData].join(
                  " "
                )
              )
          ...
          },
          {
            ...
            content: grid
              ...
              .replace(
                "#{data}",
                ['data-id="cardgrid"', commonData, singleData, multiData].join(
                  " "
                )
              )
              .replace(
